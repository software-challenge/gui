        ...
        hbox {
            ...
            button {
                ...
                disableProperty().bind(
                    arrayOf<ObservableValue<Boolean>>(
...
// FIXME not properly debugged until today
//       why sometimes buttons start shrinking on hover
fun Button.fixHoverInsets() = apply {
    //paddingProperty().bind(SimpleObjectProperty(Insets(AppStyle.formSpacing)))
}
